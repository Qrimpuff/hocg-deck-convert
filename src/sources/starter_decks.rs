...
fn starter_decks(db: &CardsDatabase) -> &'static Vec<DeckEntry> {
    ...
    DECKS.get_or_init(|| {
        vec![
            ...
            DeckEntry {
                deck_id: "hSD14-001".into(),
                display: "hSD14 - Live Start Deck Shirakami Fubuki".into(),
                oshi_options: None,
                deck: CommonDeck {
                    name: Some("Live Start Deck Shirakami Fubuki".into()),
                    oshi: Some(card("hSD14-001", (Japanese, 2065), 1, db)),
                    main_deck: vec![
                        card("hSD14-002", (Japanese, 2066), 4, db),
                        card("hSD14-003", (Japanese, 2067), 4, db),
                        card("hSD14-004", (Japanese, 2068), 4, db),
                        card("hSD14-005", (Japanese, 2069), 4, db),
                        card("hSD14-006", (Japanese, 2070), 4, db),
                        card("hSD14-007", (Japanese, 2071), 4, db),
                        card("hSD14-008", (Japanese, 2072), 4, db),
                        card("hSD14-009", (Japanese, 2073), 4, db),
                        card("hSD14-010", (Japanese, 2074), 4, db),
                        card("hSD14-011", (Japanese, 2075), 4, db),
                        card("hSD01-017", (Japanese, 17), 3, db),
                        card("hBP01-104", (Japanese, 2076), 2, db),
                        card("hSD01-019", (Japanese, 19), 1, db),
                        card("hBP02-077", (Japanese, 344), 1, db),
                        card("hBP02-084", (Japanese, 351), 3, db),
                    ],
                    cheer_deck: vec![card("hY01-001", (Japanese, 168), 20, db)],
                },
            },
            ...
            DeckEntry {
                deck_id: "hSD15-001".into(),
                display: "hSD15 - Live Start Deck Juufuutei Raden".into(),
                oshi_options: None,
                deck: CommonDeck {
                    name: Some("Live Start Deck Juufuutei Raden".into()),
                    oshi: Some(card("hSD15-001", (Japanese, 2077), 1, db)),
                    main_deck: vec![
                        card("hSD15-002", (Japanese, 2078), 4, db),
                        card("hSD15-003", (Japanese, 2079), 4, db),
                        card("hSD15-004", (Japanese, 2080), 4, db),
                        card("hSD15-005", (Japanese, 2081), 4, db),
                        card("hSD15-006", (Japanese, 2082), 4, db),
                        card("hSD15-007", (Japanese, 2083), 4, db),
                        card("hSD15-008", (Japanese, 2084), 4, db),
                        card("hSD15-009", (Japanese, 2085), 4, db),
                        card("hSD15-010", (Japanese, 2086), 4, db),
                        card("hSD14-010", (Japanese, 2074), 4, db),
                        card("hSD01-017", (Japanese, 17), 3, db),
                        card("hBP01-104", (Japanese, 2087), 2, db),
                        card("hSD01-019", (Japanese, 19), 1, db),
                        card("hBP02-077", (Japanese, 344), 1, db),
                        card("hBP02-084", (Japanese, 351), 3, db),
                    ],
            ...
            DeckEntry {
                deck_id: "hSD16-001".into(),
                display: "hSD16 - Live Start Deck Sakura Miko".into(),
                oshi_options: None,
                deck: CommonDeck {
                    name: Some("Live Start Deck Sakura Miko".into()),
                    oshi: Some(card("hSD16-001", (Japanese, 2088), 1, db)),
                    main_deck: vec![
                        card("hSD16-002", (Japanese, 2089), 4, db),
                        card("hSD16-003", (Japanese, 2090), 4, db),
                        card("hSD16-004", (Japanese, 2091), 4, db),
                        card("hSD16-005", (Japanese, 2092), 4, db),
                        card("hSD16-006", (Japanese, 2093), 4, db),
                        card("hSD16-007", (Japanese, 2094), 4, db),
                        card("hSD16-008", (Japanese, 2095), 4, db),
                        card("hSD16-009", (Japanese, 2096), 4, db),
                        card("hSD14-010", (Japanese, 2074), 4, db),
                        card("hSD01-017", (Japanese, 17), 3, db),
                        card("hBP01-104", (Japanese, 2097), 2, db),
                        card("hSD01-019", (Japanese, 19), 1, db),
                        card("hBP02-077", (Japanese, 344), 1, db),
                        card("hBP02-084", (Japanese, 351), 3, db),
                        card("hBP03-107", (Japanese, 671), 4, db),
                    ],
                    cheer_deck: vec![card("hY03-001", (Japanese, 170), 20, db)],
                },
            },
            ...
            DeckEntry {
                deck_id: "hSD17-001".into(),
                display: "hSD17 - Live Start Deck Hoshimachi Suisei".into(),
                oshi_options: None,
                deck: CommonDeck {
                    name: Some("Live Start Deck Hoshimachi Suisei".into()),
                    oshi: Some(card("hSD17-001", (Japanese, 2098), 1, db)),
                    main_deck: vec![
                        card("hSD17-002", (Japanese, 2099), 4, db),
                        card("hSD17-003", (Japanese, 2100), 4, db),
                        card("hSD17-004", (Japanese, 2101), 4, db),
                        card("hSD17-005", (Japanese, 2102), 4, db),
                        card("hSD17-006", (Japanese, 2103), 4, db),
                        card("hSD17-007", (Japanese, 2104), 4, db),
                        card("hSD17-008", (Japanese, 2105), 4, db),
                        card("hSD17-009", (Japanese, 2106), 4, db),
                        card("hSD17-010", (Japanese, 2107), 4, db),
                        card("hSD14-010", (Japanese, 2074), 4, db),
                        card("hSD01-017", (Japanese, 17), 3, db),
                        card("hBP01-104", (Japanese, 2108), 2, db),
                        card("hSD01-019", (Japanese, 19), 1, db),
                        card("hBP02-077", (Japanese, 344), 1, db),
                        card("hBP02-084", (Japanese, 351), 3, db),
                    ],
            ...
            DeckEntry {
                deck_id: "hSD18-001".into(),
                display: "hSD18 - Live Start Deck Mori Calliope".into(),
                oshi_options: None,
                deck: CommonDeck {
                    name: Some("Live Start Deck Mori Calliope".into()),
                    oshi: Some(card("hSD18-001", (Japanese, 2109), 1, db)),
                    main_deck: vec![
                        card("hSD18-002", (Japanese, 2110), 4, db),
                        card("hSD18-003", (Japanese, 2111), 4, db),
                        card("hSD18-004", (Japanese, 2112), 4, db),
                        card("hSD18-005", (Japanese, 2113), 4, db),
                        card("hSD18-006", (Japanese, 2114), 4, db),
                        card("hSD18-007", (Japanese, 2115), 4, db),
                        card("hSD18-008", (Japanese, 2116), 4, db),
                        card("hSD18-009", (Japanese, 2117), 4, db),
                        card("hSD14-010", (Japanese, 2074), 4, db),
                        card("hSD01-017", (Japanese, 17), 3, db),
                        card("hBP01-104", (Japanese, 2118), 2, db),
                        card("hBP02-077", (Japanese, 344), 2, db),
                        card("hBP02-084", (Japanese, 351), 3, db),
                        card("hBP02-088", (Japanese, 355), 4, db),
                    ],
                    cheer_deck: vec![card("hY05-001", (Japanese, 267), 20, db)],
                },
            },
            ...
            DeckEntry {
                deck_id: "hSD19-001".into(),
                display: "hSD19 - Live Start Deck Oozora Subaru".into(),
                oshi_options: None,
                deck: CommonDeck {
                    name: Some("Live Start Deck Oozora Subaru".into()),
                    oshi: Some(card("hSD19-001", (Japanese, 2119), 1, db)),
                    main_deck: vec![
                        card("hSD19-002", (Japanese, 2120), 4, db),
                        card("hSD19-003", (Japanese, 2121), 4, db),
                        card("hSD19-004", (Japanese, 2122), 4, db),
                        card("hSD19-005", (Japanese, 2123), 4, db),
                        card("hSD19-006", (Japanese, 2124), 4, db),
                        card("hSD19-007", (Japanese, 2125), 4, db),
                        card("hSD19-008", (Japanese, 2126), 4, db),
                        card("hSD19-009", (Japanese, 2127), 4, db),
                        card("hSD19-010", (Japanese, 2128), 4, db),
                        card("hSD14-010", (Japanese, 2074), 4, db),
                        card("hSD01-017", (Japanese, 17), 3, db),
                        card("hBP01-104", (Japanese, 2129), 2, db),
                        card("hSD01-019", (Japanese, 19), 1, db),
                        card("hBP02-077", (Japanese, 344), 1, db),
                        card("hBP02-084", (Japanese, 351), 3, db),
                    ],
