...
impl CommonCardsConversion for OshiCard {
    ...
    fn from_common_cards(cards: CommonCards, info: &CardsInfo) -> Self {
        OshiCard(cards.card_number.clone(), cards.delta_art_index(info))
    }

    fn to_common_cards(value: Self, info: &CardsInfo) -> CommonCards {
        CommonCards::from_card_number_and_delta_art_index(value.0, value.1, 1, info)
    }
...
impl CommonCardsConversion for DeckCards {
    ...
    fn from_common_cards(cards: CommonCards, info: &CardsInfo) -> Self {
        DeckCards(
            ...
            cards.amount,
            cards.delta_art_index(info),
        )
    }

    fn to_common_cards(value: Self, info: &CardsInfo) -> CommonCards {
        CommonCards::from_card_number_and_delta_art_index(value.0, value.2, value.1, info)
    }
